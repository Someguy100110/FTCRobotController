...
@TeleOp(name="! Current Android Teleop !")
...
public class NewTeleOp extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        while(opModeIsActive())
        {
            ...
            if((lift.getCurrentPosition() < 0 && gamepad1.left_trigger != 0) || gamepad1.a){
                lift.setPower(2*gamepad1.left_trigger-2*gamepad1.right_trigger);
            }
            if(lift.getCurrentPosition() >     -8000 && gamepad1.right_trigger != 0){
                lift.setPower(2*gamepad1.left_trigger-2*gamepad1.right_trigger);
            }
